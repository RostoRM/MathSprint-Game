...
const updateBestScore = () => {
  bestScoreArray.forEach((score, i) => {
    // Select correct Best Scote to Update
    if (questionAmount == score.questions) {
      // Return Best Scoreas number with one decimal
...
// Form that decides which  amount questions to choose
...
startForm.addEventListener('click', () => {
  radioContainers.forEach((radioEl) => {
    ...
    // Add Selected Label back if th radio input is checked
